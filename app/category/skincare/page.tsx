...
type SkincareProduct = {
  ...
  price: number;
  description: string;
  category: "Serum" | "Cream" | "Cleanser" | "Toner" | "Mask";
  imageUrl: string;
...
const skincareProducts: SkincareProduct[] = [
  {
    ...
    category: "Serum",
    imageUrl: "https://plus.unsplash.com/premium_photo-1661630971367-15853002aee8?w=600&auto=format&fit=crop&q=60",
    hoverImageUrl: "https://plus.unsplash.com/premium_photo-1661630971367-15853002aee8?w=600&auto=format&fit=crop&q=60",
  ...
  },
  {
    ...
    category: "Cream",
    imageUrl: "https://plus.unsplash.com/premium_photo-1679046948896-5f9aa56900e9?w=600&auto=format&fit=crop&q=60",
    hoverImageUrl: "https://plus.unsplash.com/premium_photo-1679046948896-5f9aa56900e9?w=600&auto=format&fit=crop&q=60",
  ...
  },
  {
    ...
    price: 295,
    description: "Advanced serum targeting the first signs of aging for a youthful complexion.",
    category: "Serum",
    imageUrl: "https://images.unsplash.com/photo-1620916566398-39f1143ab7be?auto=format&fit=crop&w=800&q=80",
    hoverImageUrl: "https://images.unsplash.com/photo-1620916566398-39f1143ab7be?auto=format&fit=crop&w=800&q=80",
    skinType: "All Skin Types",
    rating: 4
  },
  {
    id: 104,
    name: "L'Huile Rosathon",
    price: 320,
    description: "A silky dry oil that nourishes and revitalizes the skin with rose extracts.",
    category: "Serum",
    imageUrl: "https://images.unsplash.com/photo-1608248597279-f99d160bfcbc?auto=format&fit=crop&w=800&q=80",
    hoverImageUrl: "https://images.unsplash.com/photo-1608248597279-f99d160bfcbc?auto=format&fit=crop&w=800&q=80",
    skinType: "All Skin Types",
  ...
  },
  {
    ...
    name: "Prestige Cream",
    price: 380,
    description: "Rich, nourishing cream that restores radiance and elasticity to tired skin.",
    category: "Cream",
    imageUrl: "https://images.unsplash.com/photo-1556228720-195a672e8a03?auto=format&fit=crop&w=800&q=80",
    hoverImageUrl: "https://images.unsplash.com/photo-1556228720-195a672e8a03?auto=format&fit=crop&w=800&q=80",
    skinType: "Mature Skin",
    rating: 4
  },
  {
    id: 106,
    name: "Sorbet Crème Exfoliante",
    price: 85,
    description: "Gentle enzymatic exfoliator for smooth, radiant skin texture.",
    category: "Cleanser",
    imageUrl: "https://images.unsplash.com/photo-1556228578-0d85b1a4d571?auto=format&fit=crop&w=800&q=80",
    hoverImageUrl: "https://images.unsplash.com/photo-1556228578-0d85b1a4d571?auto=format&fit=crop&w=800&q=80",
    skinType: "All Skin Types",
    isNew: true,
    rating: 4
  }
...
const subCategories = ["All", "Serum", "Cream", "Cleanser", "Toner", "Mask"];
...
function ProductCard({ 
  ...
  onLeave: () => void;
  onAddToBag: (product: SkincareProduct) => void;
  index: number;
  isLargeCard?: boolean;
}) {
  return (
...
export default function SkincareCategoryPage() {
  ...
  const filteredProducts = useMemo(() => {
    if (activeCategory === "All") return skincareProducts;
    return skincareProducts.filter(p => p.category === activeCategory);
  }, [activeCategory]);

  const handleAddToBag = (product: SkincareProduct) => {
    addToCart({
      id: product.id,
      title: product.name,
      price: product.price,
      ...
      <div className="mx-auto max-w-[1440px] px-6 pb-24 pt-28 md:px-10 lg:px-14">
        ...
        <section className="mb-16 grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          >
            <nav aria-label="Breadcrumb" className="mb-6 text-xs uppercase tracking-[0.2em] text-[#7a6b6f]">
              <ol className="flex items-center gap-2">
                ...
                <li className="text-[#4c202a]">Skincare</li>
              </ol>
            </nav>
            ...
            <p className="mt-8 max-w-md font-sans text-base leading-relaxed tracking-widest text-[#22171b]/80">
              Experience the alchemy of science and nature. A timeless collection for your skin's radiance.
            </p>
          ...
          >
            ...
            >
              <Image
                src="https://plus.unsplash.com/premium_photo-1661630971367-15853002aee8?w=1200&auto=format&fit=crop&q=60"
              ...
              <div className="absolute bottom-8 left-8">
                ...
                <h3 className="mt-3 font-serif text-2xl text-white">L'Or de Vie Le Sérum</h3>
                <p className="mt-1 text-sm text-white/80">$450.00</p>
              </div>
            </motion.div>
          </motion.div>
        </section>
